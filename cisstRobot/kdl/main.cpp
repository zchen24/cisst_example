...
//    robCisst.
    ...
    // 2
    inert = RigidBodyInertia(0.00, KDL::Vector(-0.15, 0, 0), RotationalInertia(0.1, 0.1, 0.1, 0.0, 0.0, 0.0));
    robKDL.addSegment(Segment(Joint(Joint::RotZ), Frame::DH(0.2794, 0.0, 0.0, -1.5708), inert));
    // 3
    inert = RigidBodyInertia(0.08, KDL::Vector(-0.15, 0, 0), RotationalInertia(0.1, 0.1, 0.1, 0.0, 0.0, 0.0));
